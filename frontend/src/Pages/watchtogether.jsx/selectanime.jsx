...
const SearchBar = () => {
  ...
  const handleWatchTogetherClick = (anime) => {
    const animeId = anime.mongoid;
      ...
      {!loading && suggestions.length > 0 && (
        <ul className="suggestions-list">
          {suggestions.map((anime, index) => (
            <li key={anime.animeid || index} className="suggestion-item">
              <img
                src={anime.image}
              ...
              <button
                ...
                onClick={() => handleWatchTogetherClick(anime)}
              >
                Watch Together
              </button>
            </li>
